...
/**
 * Schema metadata for one entity exposed by a {@link com.telcobright.party.v2.providers.UserRepoProvider}.
 *
 * The provider discovers this by probing the underlying source at startup
 ...
 * @param source    which provider type produced this (e.g. "odoo")
